...
global.owner = process.env.OWNER_NUMBER  || '94716214118' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=3N81EJqa#lRsnLvQfg1S4C8KgLNPQbe9txmi94KKXl2lp5V31uHQ' ,
